...
void CssTags::defineInitialSymbol(const StringA& cssText, LInt cssType)
{
	// use hashmap accelerate search speed
	m_map.set(StringUtils::hashCode(cssText), cssType);
}
...
int CssTags::symbolAsInt(LUint inSymbol)
{
	return m_map[inSymbol];
}
